...
public class Main
{
    ...
    // Переменная сканер типа сканер для считывания текста
    private static Scanner scanner;
    // Переменная ИндексСтанции типа ИндексСтанции для хранения индекса станции
    ...
    private static Station takeStation(String message) {
        for(;;) {
            ...
            if(station != null) {
                logger.info("Ввод с клавиатуры - " + line + " | " + "Мы нашли - " + station);
                return station;
            }
